...
<head>
    ...
    <link href="https://resources.joker.im/Content/bootstrap.css" rel="stylesheet"/>
    <link rel="icon" href="https://resources.joker.im/favicon_code.ico" type="image/x-icon"/>
    <link rel="shortcut icon" href="https://resources.joker.im/favicon_code.ico" type="image/x-icon"/>
    <link href="https://resources.joker.im/Fonts/css/fontawesome.css" media="all" rel="stylesheet"/>
    <link href="https://resources.joker.im/Fonts/css/fontawesome-all.css" media="all" rel="stylesheet"/>
    <link href="styles.css" media="all" rel="stylesheet"/>
    <script src="https://resources.joker.im/Scripts/jquery-3.1.1.js"></script>
    <script src="https://resources.joker.im/Scripts/bootstrap.bundle.js"></script>
